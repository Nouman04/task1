...
<body>
    ...
    <div class="container-fluid mt-5">
        ...
        <div class="container">
            ...
            <div class="row">
                <?php for($i=1; $i<=sizeof($allProducts); $i++) {?>
                <div class="col-lg-4 mb-3">
                    <div class="card" style="width: 18rem;">
                        <img src="/task1/views/uploads/<?=$allProducts[$i]['image']?>" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"><?=$allProducts[$i]['title'] ?></h5>
                            <p class="card-text"><b>Price:<?=$allProducts[$i]['price']?>$</b></p>
                            <a href="product-details/<?=$allProducts[$i]['id']?>" class="btn btn-primary">Details</a>
                        </div>
                    </div>
                </div>
                <?php } ?>
